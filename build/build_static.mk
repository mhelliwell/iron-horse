...
IH_LOCAL_OBJ_PATH := $(IH_OBJ_WORKING_PATH)$(LOCAL_MODULE_NAME)/static/
...
# set the link rule
define make-static-target
$(1): $(IH_OBJ_TARGET)
	@ar rcs $(IH_LIB_RESULTS_PATH)$(LOCAL_MODULE_NAME).a $(IH_LOCAL_ALL_OBJS)
endef
$(eval $(call gen_sym, IH_LINK_TARGET, $(IH_TARGET_PREFIX)_link))
$(eval $(call make-static-target, $(IH_LINK_TARGET)))
