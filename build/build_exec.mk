...
IH_LOCAL_OBJ_PATH := $(IH_OBJ_WORKING_PATH)$(LOCAL_MODULE_NAME)/
...
$(1): $(IH_OBJ_TARGET)
	@g++ $(IH_LOCAL_ALL_OBJS) $(IH_LOCAL_LDFLAGS) -Wl,-rpath=../lib,-rpath=.  -o $(IH_BIN_RESULTS_PATH)$(LOCAL_MODULE_NAME)
endef
